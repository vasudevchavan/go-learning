...
func main() {
	...
	b := NewHtmlBuilder("ul")
	b.root.elements = append(b.root.elements, HtmlElement{"li", "hello", nil})
	b.root.elements = append(b.root.elements, HtmlElement{"li", "world", nil})
	fmt.Println(b.String())

	c := NewHtmlBuilder("ul")
	c.AddChildFluent("li", "hello").
