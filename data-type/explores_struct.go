...
func main() {
	...
	var person1 skillPerson
	person1.Name = "John"
	person1.Skill = []string{"Go", "Python", "Java"}
	fmt.Println("Person 1:", person1)

	// Declaration of a slice of structs to add multiple persons
	var person2 []skillPerson
	person2 = append(person2, person1)
	person2 = append(person2, skillPerson{Name: "Alice", Skill: []string{"JavaScript", "C++"}})
	person2 = append(person2, skillPerson{Name: "Bob", Skill: []string{"Ruby", "PHP"}})
